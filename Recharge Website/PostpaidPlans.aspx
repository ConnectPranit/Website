<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PostpaidPlans.aspx.cs" Inherits="Recharge_Website.PospaidPlans" %>
...
<head runat="server">
    ...
    <title>Vi-Post-Paid Plans</title>
...
<body>
    <form id="PostpaidId" runat="server">
        <div>			
...
<div class="card-deck">
  <div class="card">
    ...
    <div class="card-body">
      <p class="card-text"><b>₹399</b>/Month</p>  
		<p class="card-text">50GB Data | Truly Unlimited Calls</p> 
		<p class="card-text"><small class="text-muted">Unlimited Data(12am to 6am)</small></p>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <p class="card-text"><b>₹499</b></p>
		<p class="card-text">90 GB Data | Truly Unlimited Calls </p> 
		<p class="card-text"><small class="text-muted">Unlimited Data(12am to 6am)</small></p>
    </div>
    <div class="card-footer">
      	<button type="button" class="btn btn-outline-danger">Buy</button>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <p class="card-text"><b>₹1101</b>/Month</p>
		<p class="card-text">Unlimited Data | Truly Unlimited Calls </p> 
...
<div class="card-deck">
  <div class="card">
      <img src="Cards/sonyLiv%20(1).jpg"  width="75"/>
    <div class="card-body">
      <p class="card-text"><b>₹599</b>/Month</p>  
      <p class="card-text">110GB Data</p>
       <p class="card-text"><small class="text-muted">200GB Roll Over</small></p>
    </div>
    <div class="card-footer">
		<button type="button" class="btn btn-outline-danger">Buy</button>
    </div>
  ...
  <div class="card">
    ...
    <p class="card-text">260 GB Data</p>
    <p class="card-text"><small class="text-muted">200 Gb Roll Over</small></p>
    </div>
    <div class="card-footer">
      	<button type="button" class="btn btn-outline-danger">Buy</button>
    </div>
  ...
  <div class="card">
     <img src="Cards/prime.jpg" width="75"  />
    <div class="card-body">
          <h5 class="card-title">₹1149</h5>
    <p class="card-text">300 GB Data</p>
    <p class="card-text"><small class="text-muted">200 Gb Roll Over</small></p>
    </div>
    <div class="card-footer">
     	<button type="button" class="btn btn-outline-danger">Buy</button>
