<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="Recharge_Website.WebForm1" %>
...
<body>
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
		...
		<div class="navbar-nav ml-auto">
            ...
            <asp:Label ID="Labelsucess" runat="server" CssClass="LoginSucess"></asp:Label>
                                         <!--- Popover-->
            <div class="pop">
...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img/ class="d-block w-100" src="Carouselimages/hero.jpg" />
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="Carouselimages/postpaid.jpg" />
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="Carouselimages/ThankYou.jpg" />
    </div>
      <div class="carousel-item">
      <img class="d-block w-100" src="Carouselimages/data.jpg" />
    </div>
  </div>
  ...
  <div class="container">
    <h3 class="display-4">Best Postpaid Plans!</h3>
<button type="button" class="btn btn-outline-danger">Check Postpaid Plans</button>
  </div>
</div>
									<!--  Recharge Card-->
<div class="card-deck">
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title"color="yellow">Best Selling Plan</h5>
      <p class="card-text"><b>₹401</b>/Month</p>  
		<p class="card-text">Unlimited Calls</p> 
		<p class="card-text">200Gb Data Rollover</p>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Vi Max</h5>
      <p class="card-text"><b>₹501</b>/Month</p>
		<p class="card-text">Unlimited Calls</p> 
		<p class="card-text">200Gb Data Rollover</p>
    </div>
    <div class="card-footer">
  ...
  <div class="card">
     <img src="Cards/prime.jpg" width="75"  />
    <div class="card-body">
      <h5 class="card-title">Red X</h5>
      <p class="card-text"><b>₹1101</b>/Month</p>
		<p class="card-text">Unlimited Calls</p> 
		<p class="card-text">Unlimited Data</p>
    </div>
    <div class="card-footer">
     	<button type="button" class="btn btn-outline-danger">Buy</button>
    </div>
...
<div class="card-deck">
  <div class="card">
      <img src="Cards/hero-unlimited.jpg" width="75" />
    <div class="card-body">
       <h5 class="card-title">Hero Unlimited</h5>
      <p class="card-text">₹299</p>  
		<p class="card-text">Unlimited Calls</p> 
		<p class="card-text">1.5gb/Day</p>
		<p class="card-text"> For 28 Days</p>
    </div>
    <div class="card-footer">
		<button type="button" class="btn btn-outline-danger">Buy</button>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Hero Unlimited</h5>
      <p class="card-text">₹478</p>
		<p class="card-text">1.5gb/Day</p>
		<p class="card-text"> For 56 Days</p>
    </div>
    <div class="card-footer">
      	<button type="button" class="btn btn-outline-danger">Buy</button>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Hero Unlimited</h5>
      <p class="card-text"><b>₹719</b>/Month</p>
		<p class="card-text">1.5gb/Day</p>
		<p class="card-text"> For 84 Days</p>
    </div>
    <div class="card-footer">
     	<button type="button" class="btn btn-outline-danger">Buy</button>
    </div>
